...
@RestController
@RequestMapping("/api/v1/capacity-technology")
...
public class CapacityTechnologyRestController {
    ...
    public Mono<ResponseEntity<Void>> saveCapacityTechnologies(@Valid @RequestBody CapacityTechnologiesRequestDto capacityTechnologiesRequestDto) {
        return capacityTechnologyHandler.saveCapacityTechnologies(capacityTechnologiesRequestDto)
    ...
    public Flux<CapacityTechnologiesResponseDto> getTechnologiesByCapacityIds(@RequestParam List<Long> capacityIds) {
        return capacityTechnologyHandler.getTechnologiesByCapacityIds(capacityIds);
    }
    ...
    public Mono<Void> deleteTechnologiesByCapacityIds(@RequestParam List<Long> capacityIds) {
        return capacityTechnologyHandler.deleteTechnologiesByCapacityIds(capacityIds);
    }
}
